...
echo "$(minikube ip)         inway.dev.rdw.minikube" | sudo tee -a /etc/hosts
...
- http://application.dev.denhaag.minikube:30080   Example application in the Den Haag example organization.
