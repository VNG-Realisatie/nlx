...
func _Directory_SetOrganizationContactDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetOrganizationContactDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DirectoryServer).SetOrganizationContactDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/directoryapi.Directory/SetOrganizationContactDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DirectoryServer).SetOrganizationContactDetails(ctx, req.(*SetOrganizationContactDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Directory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetOrganizationContactDetails",
			Handler:    _Directory_SetOrganizationContactDetails_Handler,
		},
		{
