                        ...
                        <tr>
                            ...
                            >
                                <button
                                    style={centerStyle}
                                    onClick={(e) =>
                                        this.props.onSort('inway_addresses')
                                    }
                                >
                                    Status
                            ...
                            >
                                <button
                                    onClick={(e) =>
                                        this.props.onSort('organization_name')
                                    }
                                >
                                    Organization
                                    {sortBy === 'organization_name' &&
                            ...
                            <th scope="col">
                                <button disabled>API Type</button>
                            </th>
                            <th scope="col">
