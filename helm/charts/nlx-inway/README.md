...
| `service.separateServices.enabled`              | If `true` two seperate services are created for Inway and Management API Proxy traffic. Set this flag to true if you want setup seperate network policies for Inway and Management API Proxy traffic.                                                                                                                                             | `false`        | no |
| `service.separateServices.inway.type`           | Service type (ClusterIP, NodePort or LoadBalancer). Please note that there should be no service performing TLS offloading as it uses mutual TLS                                                                                                                                                                                                   | `LoadBalancer` | no |
| `service.separateServices.inway.port`           | Port exposed by the service for Inway traffic.                                                                                                                                                                                                                                                                                                    | `443`          | no |
| `service.separateServices.inway.nodePort`       | Port exposed for Inway traffic if `service.type` is `NodePort`.                                                                                                                                                                                                                                                                                   | `""`           | no |
| `service.separateServices.inway.annotations`    | You can use Kubernetes annotations to attach arbitrary non-identifying metadata to objects. Clients such as tools and libraries can retrieve this metadata.                                                                                                                                                                                       | `{}`           | no |
| `service.separateServices.inway.loadBalancerIP` | Only applies when using `service.type`: 'LoadBalancer'. A loadBalancer will get created with the IP specified in this field. This feature depends on whether the underlying cloud-provider supports specifying the loadBalancerIP when a load balancer is created. This field will be ignored if the cloud-provider does not support the feature. | `""`           | no |
| `service.separateServices.managementAPIProxy.type`           | Service type (ClusterIP, NodePort or LoadBalancer). Please note that there should be no service performing TLS offloading as it uses mutual TLS                                                                                                                                                                                                   | `LoadBalancer` | no |
| `service.separateServices.managementAPIProxy.port`           | Port exposed by the service for Management API Proxy traffic.                                                                                                                                                                                                                                                                                     | `443`          | no |
| `service.separateServices.managementAPIProxy.nodePort`       | Port exposed for Management API Proxy traffic if `service.type` is `NodePort`.                                                                                                                                                                                                                                                                              | `""`           | no |
| `service.separateServices.managementAPIProxy.annotations`    | You can use Kubernetes annotations to attach arbitrary non-identifying metadata to objects. Clients such as tools and libraries can retrieve this metadata.                                                                                                                                                                                       | `{}`           | no |
| `service.separateServices.managementAPIProxy.loadBalancerIP` | Only applies when using `service.type`: 'LoadBalancer'. A loadBalancer will get created with the IP specified in this field. This feature depends on whether the underlying cloud-provider supports specifying the loadBalancerIP when a load balancer is created. This field will be ignored if the cloud-provider does not support the feature. | `""`           | no |
