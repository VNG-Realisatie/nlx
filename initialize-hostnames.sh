...
echo "${minikube_ip}                         management.nlx-dev-rdw.minikube" | sudo tee -a /etc/hosts
...
echo "${minikube_ip}                         management.nlx-dev-brp.minikube" | sudo tee -a /etc/hosts
...
echo "${minikube_ip}                     management.nlx-dev-haarlem.minikube" | sudo tee -a /etc/hosts
