...
# The API base URL should be configurable at run-time. Because Nginx does not support using environment variables
...
echo "window._env = { \"NAVBAR_HOME_PAGE_URL\": \"${NAVBAR_HOME_PAGE_URL}\", \"NAVBAR_ABOUT_PAGE_URL\": \"${NAVBAR_ABOUT_PAGE_URL}\", \"NAVBAR_DOCS_PAGE_URL\": \"${NAVBAR_DOCS_PAGE_URL}\", \"NAVBAR_DIRECTORY_URL\": \"${NAVBAR_DIRECTORY_URL}\" }" > /usr/share/nginx/html/env.js
