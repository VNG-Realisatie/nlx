...
func (m *RequestAccessResponse) Reset()         { *m = RequestAccessResponse{} }
func (m *RequestAccessResponse) String() string { return proto.CompactTextString(m) }
func (*RequestAccessResponse) ProtoMessage()    {}
func (*RequestAccessResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2b7268f56e161ef5, []int{4}
}
func (m *RequestAccessResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestAccessResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestAccessResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestAccessResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestAccessResponse.Merge(m, src)
}
func (m *RequestAccessResponse) XXX_Size() int {
	return m.Size()
}
func (m *RequestAccessResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestAccessResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RequestAccessResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RequestAccessResponse)(nil), "nlx.management.external.RequestAccessResponse")
}
...
var fileDescriptor_2b7268f56e161ef5 = []byte{
	...
	,
}
...
func (*UnimplementedAccessRequestServiceServer) RequestAccess(ctx context.Context, req *RequestAccessRequest) (*RequestAccessResponse, error) {
...
func (m *RequestAccessResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestAccessResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestAccessResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ReferenceId != 0 {
		i = encodeVarintExternal(dAtA, i, uint64(m.ReferenceId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *RequestAccessResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ReferenceId != 0 {
		n += 1 + sovExternal(uint64(m.ReferenceId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *RequestAccessResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestAccessResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestAccessResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
