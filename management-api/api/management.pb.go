...
type DirectoryService struct {
	...
	PublicSupportContact string                 `protobuf:"bytes,4,opt,name=publicSupportContact,proto3" json:"publicSupportContact,omitempty"`
	State                DirectoryService_State `protobuf:"varint,5,opt,name=state,proto3,enum=nlx.management.DirectoryService_State" json:"state,omitempty"`
	LatestAccessRequest  *OutgoingAccessRequest `protobuf:"bytes,6,opt,name=latestAccessRequest,proto3" json:"latestAccessRequest,omitempty"`
	LatestAccessProof    *AccessProof           `protobuf:"bytes,7,opt,name=latestAccessProof,proto3" json:"latestAccessProof,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
