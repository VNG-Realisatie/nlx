...
(
    incoming_order_id BIGSERIAL    NOT NULL,
...
CREATE UNIQUE INDEX idx_incoming_orders_services ON nlx_management.incoming_orders_services (incoming_order_id, service, organization);
