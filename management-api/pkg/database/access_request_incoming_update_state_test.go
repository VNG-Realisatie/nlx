...
func TestUpdateIncomingAccessRequestState(t *testing.T) {
	t.Parallel()
	...
	type args struct {
		...
		state           database.IncomingAccessRequestState
	}
	...
	for name, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			err := configDb.UpdateIncomingAccessRequestState(context.Background(), tt.args.accessRequestID, tt.args.state)
