...
import (
	...
	zaplogger "go.nlx.io/nlx/management-ui-fsc/adapters/logger/zap"
	uiport "go.nlx.io/nlx/management-ui-fsc/ports/ui"
	"go.nlx.io/nlx/management-ui-fsc/service"
)
...
var serveCommand = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		uiServer, err := uiport.New("nl", staticFilesPath, logger, app)
