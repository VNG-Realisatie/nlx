...
const InsightSettings = ({ getSettings, updateHandler }) => {
...
InsightSettings.propTypes = {
  updateHandler: func,
  getSettings: func,
}

InsightSettings.defaultProps = {
  updateHandler: SettingsRepository.updateInsightSettings,
  getSettings: SettingsRepository.getInsightSettings,
}
