#!/bin/bash
#
# Migrate the database for transactions to its latest state.
#
# Usage: ./upgrade-db.sh
#
...
psql --echo-errors --variable "ON_ERROR_STOP=1" "dbname=postgres sslmode=disable connect_timeout=5" <<EOF
